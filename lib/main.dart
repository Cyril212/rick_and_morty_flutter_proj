  ...
  Widget build(BuildContext context) {
    return MultiProvider(
        providers: [
          ...
          RepositoryProvider(create: (context) => CharacterListRepository(
                  context.read<DataClient>(), CharacterListSource(context.read<DataClient>().manager, CharacterListRequest("character")))),
          BlocProvider(create: (context) => RickMortyListVM(context.read<CharacterListRepository>())),
          BlocProvider(create: (context) => RickMortyDetailVM())
        ],
        child: MaterialApp(
